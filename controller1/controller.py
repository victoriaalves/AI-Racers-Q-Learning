...
class Controller(controller_template.Controller):
    ...
    """
    Retorna o valor Q mais alto de state
    """
    ...
    """
    Retorna a melhor acao do state
    """
    ...
    def take_action(self, new_state: State, episode_number: int) -> int:
        ...
        (Esquerda, Direita, Acelerar, Frear, A?oNula).
        """
        if(episode_number == 99): #usado para salvar
            self.i = 99
